...
public class ScienceTableRecipeCategory implements IRecipeCategory<SeaTableRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(IdeaOMod.MOD_ID, "science");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(IdeaOMod.MOD_ID, "textures/gui/science_table_gui.png");

    private final IDrawable background;
    private final IDrawable icon;

    public ScienceTableRecipeCategory(IGuiHelper helper) {
